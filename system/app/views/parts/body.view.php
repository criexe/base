...
<link rel="stylesheet" href="<?= SYS_ASSETS ?>/cx/plugins/perfect-scrollbar/css/perfect-scrollbar.min.css">
<script type="text/javascript" src="<?= SYS_ASSETS ?>/cx/plugins/perfect-scrollbar/js/perfect-scrollbar.jquery.js"></script>